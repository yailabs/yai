...
pub static CAPABILITIES: &[ProductCapabilityDescriptor] = &[
    ...
    capability("case.lifecycle", "Create, open, run, stop, cancel and close governed Cases", "Case transition/controller owners", &["K03", "X01"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &["case.cancel", "case.close", "case.create", "case.open", "case.run", "case.stop", "execution.get"], CASE_RUNTIME_BLOCKED, CliPosture::Exposed, &["yai.case.create", "yai.case.run", "yai.case.resume", "yai.case.stop", "yai.case.cancel", "yai.case.close"], None, StudioPosture::UiTarget, None, None),
