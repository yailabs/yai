...
pub static APPLICATION_OPERATIONS: &[ApplicationOperationDescriptor] = &[
    ...
    operation("execution.get", "Observe an exact durable submission without redispatch; admitted participant Resource requests expose exact continuation input, and optional Conversation context inspection requalifies archived W under current disclosure", "yai.execution_get_input.v1", "yai.execution_observation.v1", StateImpact::Read, AuthorityClass::CurrentCaseAuthority),
