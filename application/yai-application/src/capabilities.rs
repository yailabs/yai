...
const APP_DEFERRED: Option<&str> = Some("Executable through the current typed domain/CLI owner; migration to a typed yai-application operation remains explicit X03 work.");
...
pub static CAPABILITIES: &[ProductCapabilityDescriptor] = &[
    ...
    capability("authority.policy.lifecycle", "Ingest, validate, publish, bind, replace, retire and revoke Policy through normal governance", "governance + case_policy", &["A01", "A02"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.policy.ingest", "yai.policy.validate", "yai.policy.publish", "yai.case.policy.bind", "yai.case.policy.replace", "yai.case.policy.unbind"], None, StudioPosture::UiTarget, None, None),
    capability("authority.review_and_grant", "Resolve authenticated Reviews and finite Grants without bypassing admission", "admission + Transition review lifecycle", &["A03", "A05"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.review.approve", "yai.review.deny", "yai.review.defer"], None, StudioPosture::UiTarget, None, None),
    ...
    capability("case.lifecycle", "Create, open, run, stop, cancel and close governed Cases", "Case transition/controller owners", &["K03", "X01"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.create", "yai.case.run", "yai.case.resume", "yai.case.stop", "yai.case.cancel", "yai.case.close"], None, StudioPosture::UiTarget, None, None),
    capability("case.participants", "Bind Participants, roles, Principal links and disclosed Participant views", "Case Participant/security transitions", &["A04"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.participant.role.add", "yai.case.participant.link_principal", "yai.case.participant.view.admit", "yai.case.participant.list"], None, StudioPosture::UiTarget, None, None),
    ...
    capability("cognitive.bindings_and_realization", "Bind cognitive roles, plan qualified providers and realize/compose explicit cognition", "cognitive bindings + provider realization", &["E01", "E03", "E04"], CapabilityDisposition::ProductAction, StateImpact::ExternalEffect, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.cognitive.bind", "yai.case.cognitive.plan", "yai.case.cognitive.realize", "yai.case.cognitive.compose"], None, StudioPosture::UiTarget, None, None),
    capability("cognitive.decision_frontier", "Construct and inspect the current finite typed Decision Frontier without scoring", "cognitive frontier + LMDB current qualification", &["E07"], CapabilityDisposition::ProductRead, StateImpact::DerivedComputation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Ready, &["decision.frontier.prepare"], None, CliPosture::Exposed, &["yai.case.cognitive.frontier"], None, StudioPosture::ApplicationReady, None, None),
    ...
    capability("cognitive.decision_request", "Prepare and inspect a W-bound non-authoritative CognitiveDecisionRequest", "Cognitive Decision Plane", &["E07"], CapabilityDisposition::ProductRead, StateImpact::DerivedComputation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Ready, &["decision.request.prepare"], None, CliPosture::Exposed, &["yai.case.cognitive.decision_request"], None, StudioPosture::ApplicationReady, None, None),
    ...
    capability("effect.controlled_execution", "Submit governed Resource/effect requests through Decision, review, PREPARE and final fences", "effect admission + carrier", &["A03", "A05", "O07"], CapabilityDisposition::ProductAction, StateImpact::ExternalEffect, AuthorityClass::ReviewGrantAndEffectFence, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.resource.request", "yai.effect.filesystem_write", "yai.effect.process_signal", "yai.effect.reconcile"], None, StudioPosture::UiTarget, None, None),
    capability("handoff.lifecycle", "Offer, accept, decline, result and reconcile explicit same-Tenant Handoffs", "Handoff transitions", &["W02"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.handoff.offer", "yai.case.handoff.accept", "yai.case.handoff.decline", "yai.case.handoff.result", "yai.case.handoff.reconcile"], None, StudioPosture::UiTarget, None, None),
    capability("identity.tenant", "Initialize local identity and inspect Tenant membership", "security bootstrap + Tenant owner", &["A04", "X01"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::LocalAuthenticated, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.init", "yai.identity.whoami", "yai.tenant.list", "yai.tenant.show", "yai.tenant.member.add"], None, StudioPosture::UiTarget, None, None),
    capability("knowledge.derived", "Build, inspect, search, resolve and navigate source-grounded documentary knowledge", "memory_hierarchy::knowledge", &["M07"], CapabilityDisposition::ProductRead, StateImpact::DerivedComputation, AuthorityClass::CaseDisclosure, ApplicationPosture::Ready, &["case.summary"], None, CliPosture::Exposed, &["yai.case.knowledge.build", "yai.case.knowledge.inspect", "yai.case.knowledge.search", "yai.case.knowledge.resolve", "yai.case.knowledge.graph", "yai.case.knowledge.wiki"], None, StudioPosture::UiAlreadyConsumed, None, None),
    ...
    capability("provider.governance", "Register, qualify, trust and bind generic provider targets", "provider governance", &["E01", "E02"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.provider.add", "yai.provider.qualify", "yai.provider.trust.approve", "yai.case.provider.bind"], None, StudioPosture::UiTarget, None, None),
    ...
    capability("resource.lifecycle", "Attach and inspect exact governed filesystem/process/other Resources", "ResourceAttachment transitions", &["O01", "O03", "O07"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.resource.attach_filesystem", "yai.case.resource.attach_process", "yai.case.resource.import", "yai.case.resource.list"], None, StudioPosture::UiTarget, None, None),
    ...
    capability("semantic.ambient_refresh", "Assess and refresh an active Conversation/Workflow consumer after admitted semantic change", "AmbientRefresh v1 + existing Recall/W compiler", &["C02", "C06"], CapabilityDisposition::ProductRead, StateImpact::DerivedComputation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.context.ambient"], None, StudioPosture::UiTarget, None, None),
    capability("semantic.recall", "Reconstruct task/query-qualified D/H/S evidence with exact closure and disclosure", "Recall v2", &["M06", "Q06"], CapabilityDisposition::ProductRead, StateImpact::DerivedComputation, AuthorityClass::CaseDisclosure, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.recall"], None, StudioPosture::UiTarget, None, None),
    ...
    capability("semantic.working_state", "Compile W3, exact-group W4 pages and explicit same-task refresh", "SemanticWorkingState compiler/refresh/paging", &["C02", "C06", "C07"], CapabilityDisposition::ProductRead, StateImpact::DerivedComputation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.context.compile", "yai.case.context.refresh", "yai.case.context.expand"], None, StudioPosture::UiTarget, None, None),
    ...
    capability("source.lifecycle", "Declare, acquire, resume, publish and revoke Case-local source relations", "source acquisition + Case source transitions", &["O08"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.case.sources.declare", "yai.case.sources.acquire", "yai.case.sources.resume", "yai.case.sources.publish", "yai.case.sources.revoke"], None, StudioPosture::UiTarget, None, None),
    capability("workflow.lifecycle", "Define, bind, advance and amend deterministic Workflow", "Workflow definitions/resolution/transitions", &["W01"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Deferred, &[], APP_DEFERRED, CliPosture::Exposed, &["yai.workflow.define", "yai.workflow.bind", "yai.workflow.input", "yai.workflow.patch.propose", "yai.workflow.patch.adopt"], None, StudioPosture::UiTarget, None, None),
