...
pub static APPLICATION_OPERATIONS: &[ApplicationOperationDescriptor] = &[
    ...
    operation("provider.models", "Discover exact exposed models from a connection or authorized registered target; timestamped metadata grants no qualification", "yai.provider_models_input.v1", "yai.provider_models.v1", StateImpact::DerivedComputation, AuthorityClass::CurrentCaseAuthority),
