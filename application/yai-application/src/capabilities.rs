...
pub static CAPABILITIES: &[ProductCapabilityDescriptor] = &[
    ...
    capability("provider.governance", "Register, qualify, trust and bind generic provider targets", "provider governance", &["E01", "E02"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Ready, &["provider.case.bind", "provider.probe", "provider.probe.get", "provider.qualify", "provider.register", "provider.suitability.record", "provider.trust.set"], None, CliPosture::Exposed, &["yai.provider.add", "yai.provider.probe", "yai.provider.qualify", "yai.provider.trust.approve", "yai.case.provider.bind"], None, StudioPosture::ApplicationReady, None, Some("Studio consumes target registration, mechanical evidence, trust and Case binding; primary-conversation operator attestation is integrated; other cognitive-capability attestation authors remain unintegrated.")),
