...
pub static CAPABILITIES: &[ProductCapabilityDescriptor] = &[
    ...
    capability("machine.asset_registry", "Register and revoke exact Tenant machine SSH identities independently of provider targets", "Tenant machine asset owner", &["X03"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::TenantOwner, ApplicationPosture::Ready, &["machine.get", "machine.list", "machine.register", "machine.revoke"], None, CliPosture::Exposed, &["yai.machine.get", "yai.machine.list", "yai.machine.register", "yai.machine.revoke"], None, StudioPosture::ApplicationReady, None, Some("Registration stores an independently attested host-key pin, not network reachability or YVEX runtime management. Remote status and lifecycle require a qualified public transport consumer.")),
