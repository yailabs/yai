...
pub static CAPABILITIES: &[ProductCapabilityDescriptor] = &[
    ...
    capability("handoff.lifecycle", "Offer, accept, decline, result and reconcile explicit same-Tenant Handoffs", "Handoff transitions", &["W02"], CapabilityDisposition::ProductAction, StateImpact::CanonicalMutation, AuthorityClass::CurrentCaseAuthority, ApplicationPosture::Ready, &["handoff.accept", "handoff.decline", "handoff.inspect", "handoff.offer", "handoff.pending", "handoff.reconcile", "handoff.result.record"], None, CliPosture::Exposed, &["yai.case.handoff.offer", "yai.case.handoff.pending", "yai.case.handoff.show", "yai.case.handoff.accept", "yai.case.handoff.decline", "yai.case.handoff.result", "yai.case.handoff.reconcile"], None, StudioPosture::ApplicationReady, None, Some("Authored mutation actions exist. Pending/inspect now share typed Application reads with CLI; Studio inbox consumption remains unqualified.")),
