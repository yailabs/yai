...
try:
    ...
    if a.operational_overview:
        ...
        script('document.querySelector(`[data-overview-section="Workflow"]`).click()')
        wait('return document.querySelector(`[data-overview-section="Workflow"]`).getAttribute("aria-selected")==="true"')
        assert script('return document.querySelectorAll(".overview-story-steps li").length') == len(before['data']['work']['nodes'])
        shot('native-overview-workflow')
        script('document.querySelector(`[data-overview-section="Sources"]`).click()')
        assert script('return document.querySelectorAll(".overview-story-evidence button").length') == len(before['data']['environment']['sources'])
        script('document.querySelector(`[data-overview-section="Situation"]`).click()')
