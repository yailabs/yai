      ...
      },
      {
        ...
        body: {
          ...
          rows: [
            ...
            { id: "matrix:source", values: { control: "Source perimeter", posture: "Qualified", owner: "Source" } },
            { id: "matrix:resource", values: { control: "Resource availability", posture: "Review", owner: "Resource" } },
            { id: "matrix:participant", values: { control: "Participant resolution", posture: "Qualified", owner: "Case" } },
            { id: "matrix:workflow", values: { control: "Workflow admission", posture: "Review", owner: "Workflow" } },
            { id: "matrix:evidence", values: { control: "Evidence retention", posture: "Qualified", owner: "Application" } },
            { id: "matrix:memory", values: { control: "Recall projection", posture: "Qualified", owner: "Memory" } },
            { id: "matrix:effect", values: { control: "External effect", posture: "Unavailable", owner: "Authority" } },
            { id: "matrix:telemetry", values: { control: "Host telemetry", posture: "Unavailable", owner: "Host" } },
            { id: "matrix:terminal", values: { control: "PTY lifecycle", posture: "Qualified", owner: "Desktop" } },
          ],
        },
      },
      {
        ...
        provenance: "Authored deterministic two-page PDF · visual qualification only",
        body: {
          kind: "pdf",
          pageCount: 2,
          source: "/fixtures/runtime-contract.pdf",
        },
      },
      {
        id: "runtime-config-json",
        name: "Runtime configuration",
        path: "Sources / runtime-config.json",
        category: "source",
        format: "JSON",
        mediaType: "application/json",
        provenance: "Authored structured-text fixture · no runtime configuration",
        body: { kind: "text", language: "json", content: "{\"applicationBoundary\":\"typed\",\"caseData\":\"fixture\",\"desktopHost\":\"independent\",\"generation\":7}" },
      },
      {
        id: "qualification-audio",
        name: "Qualification tone",
        path: "Sources / qualification-tone.wav",
        category: "source",
        format: "Audio",
        mediaType: "audio/wav",
        provenance: "Generated deterministic audio fixture · no transcript",
        body: { kind: "audio", source: "/fixtures/qualification-tone.wav", durationSeconds: 1.5, caption: "A deterministic tone used only to qualify native media playback." },
      },
      {
        id: "qualification-video",
        name: "Qualification clip",
        path: "Sources / qualification-clip.webm",
        category: "source",
        format: "Video",
        mediaType: "video/webm",
        provenance: "Generated deterministic video fixture · visual qualification only",
        body: { kind: "video", source: "/fixtures/qualification-clip.webm", durationSeconds: 1.5, caption: "A deterministic clip used only to qualify native media playback." },
      },
      {
        id: "runtime-binary",
        name: "Runtime capture",
        path: "Sources / runtime.capture",
        category: "source",
        format: "Binary",
        mediaType: "application/octet-stream",
        provenance: "Authored unknown-format identity · no binary bytes loaded",
        body: { kind: "text", content: "This content must not be rendered as text by the unknown-material Surface." },
      },
      {
        id: "work",
