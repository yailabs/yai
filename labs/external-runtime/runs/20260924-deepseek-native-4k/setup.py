...
home=Path('/home/mothx/.yai');h=Host(home);case='case:qualification-deepseek-native-4k';run='native-4k-setup-'+str(time.time_ns());p=Path('/home/mothx/.cache/tmp')/(run+'.jsonl');f=p.open('x');order=0
def call(op,i):
 global order
