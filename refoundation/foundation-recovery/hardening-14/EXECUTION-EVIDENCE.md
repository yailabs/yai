...
These are bounded raw excerpts from actual pre-publication executions on
2026-09-01. A publication-bound evidence run is appended after the semantic
commit; outputs are never reconstructed.
