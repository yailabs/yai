...
| Studio product/frontend specification | [studio.md](studio.md) | Case Workbench composition, client/native boundaries and future qualification criteria | Case semantics, runtime truth, maturity promotion or a second execution queue |
