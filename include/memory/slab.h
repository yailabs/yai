...
#define __SLAB_FLAG_BIT(nr)	((slab_flags_t )(1U << (nr)))
#define __SLAB_FLAG_UNUSED	((slab_flags_t )(0U))
 ...
 * include/yai/gfp_types.h and described at
 ...
 */
static inline __realloc_size(2, 3) void *  krealloc_array_noprof(void *p,
								       size_t new_n,
								       size_t new_size,
								       gfp_t flags)
{
