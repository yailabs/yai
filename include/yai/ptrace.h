...
#include <yai/compiler.h>		/* For unlikely.  */
#include <yai/sched.h>		/* For struct task_struct.  */
#include <yai/sched/signal.h>		/* For send_sig(), same_thread_group(), etc. */
#include <yai/err.h>			/* for IS_ERR_VALUE */
#include <yai/bug.h>			/* For BUG_ON.  */
#include <yai/pid_namespace.h>	/* For task_active_pid_ns.  */
#include <yai/uapi/ptrace.h>
