 ...
 * - 0x1: initrd loading from the YAI_EFI_INITRD_MEDIA_GUID device path,
 ...
 * via the YAI_EFI_INITRD_MEDIA_GUID device path.
 *
 ...
 */
#define YAI_EFISTUB_MAJOR_VERSION		0x3
#define YAI_EFISTUB_MINOR_VERSION		0x0

/*
 * YAI_PE_MAGIC appears at offset 0x38 into the MS-DOS header of EFI bootable
 * Linux kernel images that target the architecture as specified by the PE/COFF
 * header machine type field.
 */
#define YAI_PE_MAGIC	0x818223cd
