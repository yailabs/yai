...
#include <yai/kernel_read_file.h>
#include <yai/key.h>
...
#include <yai/bpf.h>
#include <yai/uapi/lsm.h>
#include <yai/lsm/selinux.h>
#include <yai/lsm/smack.h>
#include <yai/lsm/apparmor.h>
#include <yai/lsm/bpf.h>
...
extern int cap_bprm_creds_from_file(struct yai_binprm *bprm, const struct file *file);
...
int security_bprm_creds_for_exec(struct yai_binprm *bprm);
int security_bprm_creds_from_file(struct yai_binprm *bprm, const struct file *file);
int security_bprm_check(struct yai_binprm *bprm);
void security_bprm_committing_creds(const struct yai_binprm *bprm);
void security_bprm_committed_creds(const struct yai_binprm *bprm);
...
static inline int security_bprm_creds_for_exec(struct yai_binprm *bprm)
{
	return 0;
}

static inline int security_bprm_creds_from_file(struct yai_binprm *bprm,
						const struct file *file)
{
	return cap_bprm_creds_from_file(bprm, file);
}

static inline int security_bprm_check(struct yai_binprm *bprm)
{
	return 0;
}

static inline void security_bprm_committing_creds(const struct yai_binprm *bprm)
{
}

static inline void security_bprm_committed_creds(const struct yai_binprm *bprm)
{
}
