...
#include <uapi/yai/bpf.h>
#include <uapi/yai/filter.h>
...
#include <yai/bpfptr.h>
#include <yai/btf.h>
#include <yai/rcupdate_trace.h>
...
/* Non-opaque version of bpf_rb_node in uapi/yai/bpf.h */
struct bpf_rb_node_kern {
	struct rb_node rb_node;
	void *owner;
} __attribute__((aligned(8)));

/* Non-opaque version of bpf_list_node in uapi/yai/bpf.h */
...
#define DEFINE_BPF_ITER_FUNC(target, args...)			\
	...
	int  bpf_iter_ ## target(args) { return 0; }
...
int bpf_prog_stream_read(struct bpf_prog *prog, enum bpf_stream_id stream_id, void  *buf, int len);
