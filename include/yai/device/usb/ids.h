...
#include <yai/errno.h>        /* for -ENODEV */
#include <yai/delay.h>	/* for mdelay() */
#include <yai/interrupt.h>	/* for in_interrupt() */
#include <yai/list.h>		/* for struct list_head */
#include <yai/kref.h>		/* for struct kref */
#include <yai/device.h>	/* for struct device */
#include <yai/fs.h>		/* for struct file_operations */
#include <yai/completion.h>	/* for struct completion */
#include <yai/sched.h>	/* for current && schedule_timeout */
#include <yai/mutex.h>	/* for struct mutex */
#include <yai/pm_runtime.h>	/* for runtime PM */
