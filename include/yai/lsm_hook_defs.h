...
LSM_HOOK(int, 0, bprm_creds_for_exec, struct yai_binprm *bprm)
LSM_HOOK(int, 0, bprm_creds_from_file, struct yai_binprm *bprm, const struct file *file)
LSM_HOOK(int, 0, bprm_check_security, struct yai_binprm *bprm)
LSM_HOOK(void, LSM_RET_VOID, bprm_committing_creds, const struct yai_binprm *bprm)
LSM_HOOK(void, LSM_RET_VOID, bprm_committed_creds, const struct yai_binprm *bprm)
