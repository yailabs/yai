...
| SO01 | 🟡 PARTIAL | Work exposes Workflow, Handoff, bounded run/stop/resume, exact execution observation and historical Decision reconstruction with current controlled-effect receipts | Output now observes exact retained Conversation responses with selected Turn and restart recovery; no complete execution catalog, process stdout, Handoff inbox or general result-body browser; retained-result file/process proposal and submit qualified; filesystem reconciliation qualified; process recovery interaction remains open | work-actions.mjs; effect-actions.mjs; conversation-actions.mjs; retained-output.mjs |
