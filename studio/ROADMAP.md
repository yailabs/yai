...
| SO03 | 🟡 PARTIAL | Explicit Handoff offer/accept/decline/result/reconcile | Authored exact refs work; typed pending/inspect reads now share the existing CLI owner checks; Studio inbox and richer result navigation open | work-actions.mjs |
