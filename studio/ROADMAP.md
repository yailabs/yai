...
| Work | Workflow, Handoff, execution owners | Typed workflow/handoff/run/resume/stop/effect/execution observation; CLI shares owners | Existing authored forms and window-retained receipt references; current-result file/process proposals and submission qualified; reconciliation, older-candidate lineage, other resume postures, Handoff inbox and complete discovery remain open |
