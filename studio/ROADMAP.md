...
| SE03 | 🟡 PARTIAL | Resource kind/bounds/requestability, process attachment and seven authored request variants with receipt observation | Six authored owner-resolved `resource.import` families including exact-digest process runners with Host retry/refusal proof; reviewed-request continuation, runner environment/write-envelope setup, content admission and catalog-qualified MCP calls remain interaction debt | source-policy-actions.mjs; effect-actions.mjs; resource-setup.mjs |
