...
| SO01 | 🟡 PARTIAL | Work center exposes Workflow, Handoff, bounded run/stop and operator-stopped checkpoint resume, exact execution observation, history and historical Decision reconstruction/evaluation | No complete execution catalog, Handoff inbox or general result-body browser | work-actions.mjs; effect-actions.mjs |
