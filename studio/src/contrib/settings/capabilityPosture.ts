...
export const studioOperationPostures: Readonly<Record<string, StudioOperationPosture>> = {
  ...
  "execution.list": { state: "debt", detail: "Published bounded discovery of current authorized execution references; authored Workbench consumption is next. This is not a complete ledger or dispatch permission." },
