...
export const studioOperationPostures: Readonly<Record<string, StudioOperationPosture>> = {
  ...
  "effect.propose": { state: "integrated", detail: "Explicit current Conversation result to owner-normalized filesystem/process Operation; prose refusal and lost-ACK exact recovery qualified. Older new candidates hit the backend latest-result fence.", proof: "tests/studio/conversation-actions.mjs" },
