...
export const studioOperationPostures: Readonly<Record<string, StudioOperationPosture>> = {
  ...
  "decision.trajectory.corpus": { state: "debt", detail: "Structured historical corpus is Application-ready; Studio has no authored export interaction or product test yet." },
  "decision.trajectory.evaluate": { state: "debt", detail: "Structural trajectory metrics are Application-ready; Studio has no authored evaluation interaction or product test yet." },
  "decision.trajectory.inspect": { state: "debt", detail: "Exact historical Decision inspection is Application-ready; Studio Work/Inspector integration remains unqualified." },
