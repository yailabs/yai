...
export function TerminalPanelView({ available }: PanelViewProps) {
  return available ? <TerminalPanel /> : <EmptyState title="Terminal requires desktop host" body="The browser Workbench does not create or emulate a shell." />;
}
