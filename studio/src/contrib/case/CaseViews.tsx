import { DeclareSourceAction, RevokeSourceAction } from "./SourceActions";
...
export function PerspectiveSurface({ workspace, input, actions, selection, platform }: SurfaceRendererProps) {
  ...
  if (perspective === "Authority") return <Authority platform={platform} selected={selection} workspace={workspace} inspect={actions.inspect} />;
