...
export function AuthoritySurface({ workspace, inspect, selected, platform }: { platform: PlatformServices; workspace: CasePresentation; selected?: string; inspect: (id: string) => void }) {
