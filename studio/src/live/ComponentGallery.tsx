...
export function ComponentGallery() {
  return <main className="gallery">
    ...
    <section><h2>Rows and panels</h2><div className="gallery-panel"><PanelHeader title="Inspector" detail="Selected Case fact" actions={<IconButton aria-label="Close"><Icon name="close" /></IconButton>} /><button className="ui-list-row"><Icon name="case" /><span><strong>case:runtime-qualification</strong><small>open</small></span><Badge tone="info">Current</Badge></button><button className="ui-list-row selected"><Icon name="review" /><span><strong>Review required</strong><small>Operation is waiting for authority</small></span></button></div></section>
