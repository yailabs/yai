...
function StartChrome({ platform }: { platform: PlatformServices }) { return <nav className="native-menu" aria-label="Application menu" data-tauri-drag-region><strong>YAI</strong><span className="native-menu-drag" data-tauri-drag-region>YAI Studio</span><DesktopWindowControls />{platform.host.capabilities.nativeDesktop && <span className="sr-only">Native desktop host</span>}</nav>; }
