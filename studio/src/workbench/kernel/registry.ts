...
export class WorkbenchRegistry implements Disposable {
  ...
  registerEditor(value: EditorContribution) { return this.insert(this.editors, value.type, value, "editor"); }
  ...
  editor(type: string) { return this.editors.get(type); }
  ...
  dispose() {
    this.containers.clear(); this.views.clear(); this.editors.clear();
