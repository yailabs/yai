 ...
 *		code split from:
 *		yai/ipv4/tcp.c
 *		yai/ipv4/tcp_input.c
 *		yai/ipv4/tcp_output.c
 *
...
int tcp_v4_err(struct sk_buff *skb, u32 info)
{
	...
	case ICMP_DEST_UNREACH:
		...
		if (code == ICMP_FRAG_NEEDED) { /* PMTU discovery (RFC1191) */
			 ...
			 * (SYN-ACKs send out by YAI are always <576bytes so
	 ...
	 * their original sense (even YAI sends invalid PORT_UNREACHs)
	 *
