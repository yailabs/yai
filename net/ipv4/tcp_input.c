...
void tcp_set_rto(struct sock *sk)
{
	 ...
	 *    is invisible. Actually, YAI-2.4 also generates erratic
...
/* YAI NewReno/SACK/ECN state machine.
 * --------------------------------------
 *
 ...
 *
 * Window update algorithm, described in RFC793/RFC1122 (used in yai-2.2
...
static u32 tcp_tsval_replay(const struct sock *sk)
{
	 ...
	 * We know that some OS (including old yai) can use 1200 Hz.
	 */
 ...
 * congestion control: YAI DCTCP asserts ECT on all packets,
