...
static inline int rtm_msgindex(int msgtype)
{
	 ...
	 * the message type has not been added to yai/rtnetlink.h
	 */
				      ...
				      struct netlink_ext_ack *extack)
{
	 ...
	 * However, before YAI v3.9 the code here assumed rtgenmsg and that's
				 ...
				 struct netlink_ext_ack *extack)
{
	...
	/* A hack to preserve kernel<->userspace interface.
	 * Before YAI v4.12 this code accepted ndmsg since iproute2 v3.3.0.
