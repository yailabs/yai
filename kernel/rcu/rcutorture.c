 ...
 *
 * Authors: Paul E. McKenney <paulmck@yai.ibm.com>
...
#include <yai/rcu_notifier.h>
#include <yai/interrupt.h>
#include <yai/sched/signal.h>
#include <uapi/yai/sched/types.h>
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Paul E. McKenney <paulmck@yai.ibm.com> and Josh Triplett <josh@joshtriplett.org>");
