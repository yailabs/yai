 ...
 * Author: Jiang Liu <jiang.liu@yai.intel.com>
 *
 ...
 * @nirqs:	The number of YAI interrupts to allocate. Can be larger
...
/**
 * msi_domain_get_virq - Lookup the YAI interrupt number for a MSI index on a interrupt domain
 * @dev:	Device to operate on
 * @domid:	Domain ID of the interrupt domain associated to the device
 * @index:	MSI interrupt index to look for (0-based)
 *
 * Return: The YAI interrupt number on success (> 0), 0 if not found
 */
 ...
 *	msi_map::virq the corresponding YAI interrupt number
 *
 ...
 * retrieve it.
 *
 * Return: The YAI interrupt number (> 0) or an error code
 */
 ...
 * @virq:	The YAI interrupt number to free
 *
