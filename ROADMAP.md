...
ESTABLISHED=32 PARTIAL=23 OPEN=12 LATER=4 TOTAL=71
...
| S12 | Historical/as-of semantic reconstruction with temporal validity | 🔴 OPEN | Replay by canonical generation exists; general event/observation/admission/validity-time queries and historically supported meaning under current disclosure do not. Separate history from current truth. |
...
| **S — Semantic Cognitive State**: preserve model-independent task and Case meaning | S01–S07/S10 foundations; typed history, evidence and consequences | Historical/current distinction, as-of validity, semantic timescales and task/big-picture state | Retain superseded material as history without treating it as current; preserve relation epistemic class | Qualified historical/current oracle and owner-specific supersession across tasks | No mega-object; H is no ledger, E/L no semantic truth |
...
| **M — Derived State & Semantic Access**: rebuildable experience and qualified Recall | W19/H19/W20; graph/analytics; canonical reconstruction for W | Temporal-causal Recall Trace, learned navigation/sparse representations, quality/scale | Exact anchors and backing before fuzzy access; temporal validity and deterministic selected-source revalidation | Discontinuous scoped Recall, exact closure/missingness and rebuild invariance beyond top-k | No RecallStore/MemoryStore; learned associations never decide truth or authority |
...
| Discontinuous temporal-causal Recall and as-of meaning | OPEN | Long Case, few relevant Episodes widely separated, many similar distractors, late evidence and one superseded conclusion. Recover the right trajectory with exact closure/missingness, keep historical material out of current truth and W bounded. M03 traversal alone cannot pass. |
...
|---|---|---|
| Now | Close the selected boundary's external Golden qualification | Exact request admission, execution/wait-budget qualification and complete real free/Workflow lifecycle; no next boundary selection |
...
| General temporal-causal memory / historical-as-of reconstruction | False. Ordered replay and bounded W20 supersession do not qualify general event/observation/admission/validity-time semantics. |
